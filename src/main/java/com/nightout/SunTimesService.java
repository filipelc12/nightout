...
/**
 * Consulta o horario de nascer e por do sol de hoje para uma coordenada,
 * usando a API publica e gratuita sunrise-sunset.org.
 */
public final class SunTimesService {
    ...
    public SunTimes fetchToday(double lat, double lon) throws IOException, InterruptedException {
        URI uri = URI.create(String.format(Locale.ROOT,
                "https://api.sunrise-sunset.org/json?lat=%f&lng=%f&formatted=0&date=today", lat, lon));
